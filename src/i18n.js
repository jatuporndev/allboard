...
const thai = {
  'CHOOSE YOUR CHALLENGE':'เลือกระดับความท้าทาย','Playable':'หัดเล่น','Casual':'สบาย ๆ','Devil':'ปีศาจ','A gentle start. Learn the board.':'เริ่มต้นสบาย ๆ เรียนรู้การเดินหมาก','A thoughtful rival. Room to learn.':'คู่ต่อสู้ที่คิดรอบคอบ พร้อมให้คุณฝึกฝน','Deeper calculation. A tougher fight.':'คิดลึกกว่า ท้าทายยิ่งกว่า','Takes more time to think.':'ใช้เวลาคิดนานขึ้น',
