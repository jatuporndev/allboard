...
const thai = {
  'CHOOSE YOUR CHALLENGE':'เลือกระดับความท้าทาย','Casual':'สบาย ๆ','Devil':'ปีศาจ','A thoughtful rival. Room to learn.':'คู่ต่อสู้ที่คิดรอบคอบ พร้อมให้คุณฝึกฝน','Deeper calculation. A tougher fight.':'คิดลึกกว่า ท้าทายยิ่งกว่า','Takes more time to think.':'ใช้เวลาคิดนานขึ้น','Casual · 5/10':'สบาย ๆ · 5/10','Devil · 10/10':'ปีศาจ · 10/10',
