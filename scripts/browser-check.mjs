...
if(!await page.locator('#casual-game').isVisible()||!await page.locator('#devil-game').isVisible())throw Error('Difficulty selection missing');
...
if(await page.locator('#solo-difficulty').innerText()!=='Casual · 5/10')throw Error('Casual label missing');
...
if(await page.locator('#solo-difficulty').innerText()!=='Devil · 10/10')throw Error('Devil label missing');
...
if(await page.locator('#solo-difficulty').innerText()!=='Devil · 10/10')throw Error('Reset lost Devil difficulty');
